...
(function ($) {
  ...
  $.fn.matasortable = function (options) {
    ...
    return this.each(function () {
      ...
      if (/^enable|disable|destroy$/.test(method)) {
        ...
        if (method === 'destroy') {
          $(this).off('sort-update');
          $(this).removeData('opts');
          citems.add(this).removeData('connectWith items')
            .off('dragstart.h5s dragend.h5s dragover.h5s dragenter.h5s drop.h5s').off('sort-update');
      ...
      items.on('dragstart.h5s', function(e) {
        ...
        dragging.parent().triggerHandler('sortstart', {item: dragging, startparent: startParent});
          ...
          if (index !== dragging.index() || startParent.get(0) !== newParent.get(0)) {
            dragging.parent().triggerHandler('sort-update', {item: dragging, oldindex: index, startparent: startParent, endparent: newParent});
          }
          dragging = null;
          draggingHeight = null;
